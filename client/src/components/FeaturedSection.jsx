        ...
        <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
            <div className='relative flex items-center justify-between pt-20 pb-10'>
                ...
                <button onClick={() => navigate('/movies')} className="group flex items-center gap-2 text-sm text-gray-300">
                    View All<ArrowRight className='group-hover:translate-x-0.5 transition w-5 h-5' />
                </button>
            </div>
            ...
            >
                <button className='px-10 py-3 text-sm bg-red-600 hover:bg-red-700 transition 
